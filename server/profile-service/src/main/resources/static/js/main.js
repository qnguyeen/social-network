...
function onConnected() {
    ...
    stompClient.send("/app/user.addUser",
        {},
        JSON.stringify({userId: userId, firstName: firstName, status: 'ONLINE'})
    );
...
function onLogout() {
    stompClient.send("/app/user.disconnectUser",
        {},
        JSON.stringify({userId: userId, firstName: firstName, status: 'OFFLINE'})
    );
...
function autoFillAndSubmitForm() {
    ...
    if (userIdParam && firstNameParam) {
        document.querySelector('#userId').value = userIdParam;
        document.querySelector('#firstName').value = firstNameParam;
        connect();
    }
}

document.addEventListener('DOMContentLoaded', autoFillAndSubmitForm);

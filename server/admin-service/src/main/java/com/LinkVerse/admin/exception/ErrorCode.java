package com.LinkVerse.admin.exception;
...
public enum ErrorCode {
    ...
    CAMPAIGN_NOT_FOUND(1049, "Campaign not found", HttpStatus.NOT_FOUND),
    ALREADY_VOLUNTEERED(1050, "Already volunteered", HttpStatus.BAD_REQUEST),
    VOLUNTEER_NOT_FOUND(1051, "Volunteer not found", HttpStatus.NOT_FOUND),
    CAMPAIGN_CLOSED(1052, "Campaign closed", HttpStatus.BAD_REQUEST),
    ;

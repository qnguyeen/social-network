...
export default function BarChartOne() {
  ...
  const { chartData, totalEngagement, percentages, growthTrend } =
    useMemo(() => {
      ...
      return {
        chartData: [
          { name: "Posts", value: timeframeData.totalPosts },
          { name: "Comments", value: timeframeData.totalComments },
          { name: "Likes", value: timeframeData.totalLikes },
        ],
    ...
    <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-lg">
      ...
      <div className="px-6 pt-6 pb-4">
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Overview of user engagement activity
            </p>
          </div>
        ...
        <div className="flex justify-between mb-6">
          ...
          <div className="text-center px-4 py-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
            <p className="text-gray-500 dark:text-gray-400 text-sm">Likes</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-white">
